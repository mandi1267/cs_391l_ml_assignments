...
def getMarkerData():
    file_name = "data_GP/AG/block1-UNWEIGHTED-SLOW-NONDOMINANT-RANDOM/20161213203046-59968-right-speed_0.500.csv"

    marker_data_1 = readData(file_name)
    marker_num = 15
    coord_string = "z"
    x_data = []
    y_data = []
    marker_data_sequences = [marker_data_1]
...
X_2, y_2 = getMarkerData()
gp_2 = GaussianProcessRegressor(kernel=kernel, alpha=0.0).fit(X_2, y_2)
print("GP2 orig kernel")
print(kernel)
print("GP2 new kernel")
print(gp_2.kernel_)
